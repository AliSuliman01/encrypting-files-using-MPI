...
char s[1000000001]; // character array to hold the input message
...
int main(int argc , char * argv[])
{
	...
	if(rank == 0){
		...
		c1 = 3;
		fgets(s, 1000000000, in) ; // takes 100 characters can be modified to receive more
